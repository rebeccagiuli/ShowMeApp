...
public class api_Movie
{
    ...
    // constructor
    public api_Movie(String posterPath, boolean adult, String overview, String releaseDate, List<Integer> genreIds, Integer id,
    ...
    public String getBackdropPath(){ return baseImageUrl + backdropPath; }
